...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action=<%=basePath%>admin/alipay.trade.page.pay method=post
			target="_blank">
		...
		<form name=tradequery action=<%=basePath%>admin/alipay.trade.query method=post
			target="_blank">
		...
		<form name=traderefund action=<%=basePath%>admin/alipay.trade.refund method=post
			target="_blank">
		...
		<form name=traderefundquery
			action=<%=basePath%>admin/alipay.trade.fastpay.refund.query method=post
			target="_blank">
		...
		<form name=tradeclose action=<%=basePath%>admin/alipay.trade.close method=post
			target="_blank">
